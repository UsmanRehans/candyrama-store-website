...
export default function CareersPage() {
  return <InfoPage eyebrow="COME MAKE SOME MAGIC" title="Bring your flavor to CandyRama" intro="We are a small Rosenberg candy team with plenty to build.">
