...
const faqs = [
  ...
  ['How quickly will my order arrive?', 'Orders are usually packed within 1 to 2 business days. Standard delivery typically takes another 3 to 5 business days after the carrier receives your package.'],
  ...
  ['Do you have gluten free candy?', 'Some products are made without gluten ingredients, but everything is packed in a shared facility that handles wheat. Always review the product label before ordering.'],
  ['What allergens are handled in your facility?', 'Our facility handles peanuts, tree nuts, milk, eggs, wheat, soy, and sesame. Cross contact is possible. Please contact us before ordering if you have a severe allergy.'],
  ['Can candy be returned?', 'Food safety rules prevent us from accepting opened or consumed candy. If an order arrives damaged, incomplete, or incorrect, contact us within 48 hours. We’ll help sort it out.'],
