...
export default function InvestorsPage() {
  return <InfoPage eyebrow="INVESTOR RELATIONS" title="Help us grow the candy aisle" intro="CandyRama is a Houston candy brand built for online orders and store shelves.">
