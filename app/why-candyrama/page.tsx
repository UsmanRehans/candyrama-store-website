...
export const metadata = {
  title: 'Why CandyRama',
  description: 'Big flavor, joyful candy, and careful packing from CandyRama in Rosenberg, Texas.',
};
...
export default function WhyCandyRamaPage() {
  return <InfoPage eyebrow="WHY CANDYRAMA" title="Candy should be the fun part" intro="Expect loud flavor and a bag that disappears fast.">
    ...
    <InfoSection title="Packed with care"><p>We check the candy, seal the bag, and pack the box at our Rosenberg home base. Your order should look good when you open it and taste even better.</p></InfoSection>
